...
<template>
    <!-- <AppLayout title="Dashboard"> -->
        ...
        <!-- <div class="py-5">
            <div class="container-xxl px-sm-3 px-lg-4 mx-auto">
                <div class="bg-white overflow-hidden shadow-lg rounded-3">
                <VideosDisplay />
                </div>
            </div>
        </div> -->
                ...
                <div class="d-flex gap-3 gap-xl-0 align-items-center">
                   <div class="d-flex align-items-center gap-2 gap-md-3">
                      <div class="logo-default">
                          <a class="navbar-brand text-info me-0" href="index.html">
                ...
                <!-- <nav id="navbar_main"
                  ...
                  <div class="container-fluid p-lg-0">
                    ...
                    <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#homePages" role="button" aria-expanded="false"
                        ...
                        <ul class="sub-nav collapse  list-unstyled border rounded-3" id="homePages">
                          ...
                          <li class="nav-item">
                            <a class="nav-link " href="home.html">Main Home
                            </a>
                          </li>
                          <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#features" role="button" aria-expanded="false"
                          aria-controls="homePages">
                          <div class="d-flex justify-content-between">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#pages" role="button" aria-expanded="false"
                          aria-controls="homePages">
                          <div class="d-flex justify-content-between">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#blog" role="button" aria-expanded="false"
                          aria-controls="blog">
                          <div class="d-flex justify-content-between">
                        ...
                        <ul class="sub-nav collapse  list-unstyled border rounded-3" id="blog">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#blog-grid" role="button" aria-expanded="false"
                          ...
                          <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#blog-sidebar" role="button" aria-expanded="false"
                          ...
                          <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#blog-single" role="button" aria-expanded="false"
                          ...
                          <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#pagination-style" role="button" aria-expanded="false"
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="video-detail.html#shop" role="button" aria-expanded="false"
                          aria-controls="shop">
                          <div class="d-flex justify-content-between">
                   ...
                   <ul
                      ...
                      <li class="nav-item dropdown iq-responsive-menu d-xl-block d-none">
                         <div class="search-box">
                            <a href="video-player" class="nav-link p-0 text-white" id="search-drop" data-bs-toggle="dropdown">
                      ...
                      <li class="nav-item">
                         <a class="nav-link shoping-cart-button text-white" href="video-player" data-bs-toggle="offcanvas"
                            data-bs-target="#shoping-cart-toggle" aria-controls="shoping-cart-toggle"
                            aria-label="Open shopping cart">
                            <i class="ph ph-bag p-0"></i>
                            <span class="bg-info text-white shopping-badge">1</span>
                         </a>
                      </li>
                      <li class="nav-item dropdown cust-itemdropdown1" id="itemdropdown1">
                         <a class="nav-link d-flex align-items-center p-0" href="video-player" id="navbarDropdown" role="button"
                               ...
                               <!-- <div class="d-flex align-items-center gap-3 rounded mb-4">
                                  <div class="image flex-shrink-0">
                                     <img src="assets/images/user/user6.jpg"
                                        class="img-fluid rounded-3 dropdown-user-menu-image" alt="Marvin McKinney">
                                  </div>
                                  <div class="content">
          ...
          <div class="product-list-content">
             <ul class="list-unstyled mb-0">
                <li class="mini-cart-item d-flex align-items-start gap-3">
                   <div class="cart-img">
                      <a href="shop/cart.html" aria-label="Bag Pack">
                   ...
                   <div class="cart-content flex-grow-1">
                      <div class="d-flex justify-content-between align-items-center">
                         <a class="d-block" href="shop/product-detail.html" aria-label="Bag Pack">
                            <h6 class="fw-500">Bag Pack</h6>
                         </a>
                         <a href="javascript:void(0)" class="delete-btn">
                            <i class="ph ph-trash text-info"></i>
                         </a>
                      </div>
       ...
       <div class="offcanvas-footer border-top py-3 px-3">
          ...
          <div class="mini-cart-buttons d-flex flex-column align-items-center gap-3 mt-4">
             <div class="iq-button w-100">
                <a href="shop/checkout.html" class="btn btn-info text-capitalize w-100 rounded-3">
                   <span class="button-text">Checkout</span>
                </a>
             </div>
             <div class="w-100">
                <a href="shop/cart.html" class="btn btn-secondary text-capitalize w-100 rounded-3">
        ...
        <div class="trending-info pt-0 pb-0">
            <div class="details-parts">
                ...
                <!-- <ul class="p-0 mb-2 list-inline d-flex flex-wrap movie-tag">
                  <li class="trending-list"><a class="" href="video-player">Action</a></li>
                  <li class="trending-list"><a class="" href="video-player">Adventure</a></li>
                  <li class="trending-list"><a class="" href="video-player">Drama</a></li>
                </ul> -->
                ...
                <div class="movie-description mt-3 mb-4" id="readmore-wrapper">
                  <p class="line-count-3 RightAnimate-two mb-0">Game of Heros is an action-packed fantasy epic where the fate of the
                    world is decided in a battle of legendary warriors. When an ancient prophecy foretells an all-out war between the
                    greatest heroes of all realms, champions from different eras and dimensions are summoned to fight for ultimate
                    supremacy. Each warrior possesses unique abilities, weapons, and a past that drives them to victory—or doom.</p>
                  <div class="iq-blog-meta-cat-tag iq-blogtag readmore-tags">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#viewMoreDataModal" class="position-relative">Read More</a>
                  </div>
                </div>
                ...
                <!-- <div class="video-language d-flex align-items-center gap-1 mt-2">
                  ...
                  <ul class="list-inline m-0 p-0 d-inline-flex align-items-center gap-3 flex-wrap">
                    <li>
                      <small class="text-capitalize">English (New Zealand)</small>
                    </li> -->
                ...
                <div class="d-flex align-items-center flex-wrap gap-3 gap-md-4 my-5">
                  <div class="iq-play-button iq-button">
                    <Link href="/video-player" class="btn btn-info w-100 rounded-3">
                  ...
                  <div class="watchlist-button-wrapper">
                    ...
                    <!-- <a href="watchlist-detail.html" class="btn btn-secondary border rounded-3" data-bs-toggle="tooltip"
                    ...
                    <div class="modal-dialog modal-dialog-centered share-modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pt-0">
                                <form id="st_creat_playlist" action="video-detail.html#" method="post">
                                ...
                                <div class="copy-link">
                                    ...
                                    <div class="input-group mb-0">
                                        <input type="text" id="copyInput" class="form-control copy-post-url" placeholder="Username"
                                            value="https://innoquad.iqonic.design/streamit-dist/frontend/html/index.html"
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="flex-shrink-0">
                                                <a download="" href="https://www.youtube.com/watch?v=X8c8EXPfqkI" class="link-info">
                                                    <i class="ph ph-download-simple"></i>
                                                </a>
                                            </div>
                                        </div>
...
<div class="container-fluid">
    <div class="overflow-hidden">
        <section class="upcomimg-block section-padding-top">
            <div class="d-flex align-items-center justify-content-between px-1 mb-2 pb-1 mb-md-4 pb-md-0">
                ...
                <h5 class="main-title text-capitalize mb-0">Others</h5>
            </div>
  ...
  <div class="block-images position-relative w-100">
    <div class="img-box w-100">
      <a href="video-player" class="position-relative top-0 bottom-0 start-0 end-0">
    ...
    <div class="card-description with-transition">
      <ul class="genres-list p-0 mb-2 d-flex align-items-center flex-wrap list-inline">
        <li class="fw-semi-bold">
          <a href="video-player" tabindex="0" class="font-size-14 ">
            Action </a>
        </li>
      </ul>
      <div class="cart-content">
        <div class="content-left">
          <h5 class="iq-title text-capitalize">
            <a href="video-player">Kung Fu Panda</a>
          </h5>
                              ...
                              <div class="block-images position-relative w-100">
                                ...
                                <div class="card-description with-transition">
                                  ...
                                  <div class="cart-content">
                                    <div class="content-left">
                                      <h5 class="iq-title text-capitalize">
                                        <a href="video-player">Lost In Space</a>
                                      </h5>
                                      <!-- <div class="d-flex align-items-center gap-3">
                                        <div class="d-flex align-items-center gap-2">
                                          <i class="ph ph-translate"></i>
                              ...
                              <div class="block-images position-relative w-100">
                                ...
                                <div class="card-description with-transition">
                                  ...
                                  <div class="cart-content">
                                    <div class="content-left">
                                      <h5 class="iq-title text-capitalize">
                                        <a href="video-player">The Dragon King</a>
                                      </h5>
                                      <!-- <div class="d-flex align-items-center gap-3">
                                        <div class="d-flex align-items-center gap-2">
                                          <i class="ph ph-translate"></i>
...
<div class="modal fade view-more-data-modal" id="viewMoreDataModal" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header pb-0">
                <h3 class="text-uppercase m-0 texture-text texture-text-modal fw-bold">ZOMBIE ISLAND</h3>
            </div>
            <div class="modal-body pt-1">
                <ul class="list-inline d-flex align-items-center flex-wrap gap-3 mt-4">
                    <li>
                        <span class="fw-medium">2017</span>
                    </li>
                ...
                <!-- <div class="d-flex align-items-baseline flex-wrap gap-2 mt-md-1 mt-2">
                    ...
                    <ul class="p-0 mb-0 list-inline d-flex flex-wrap movie-tag">
                        <li class="trending-list"><a href="video-player">Adventure</a></li>
                        <li class="trending-list"><a href="video-player">Animation</a>
                        </li>
                        <li class="trending-list"><a href="video-player">Crime</a>
                        </li>
                    </ul>
                </div> -->
                ...
                <!-- <div class="d-flex align-items-baseline flex-wrap gap-2 mt-3">
                    ...
                    <ul
                        ...
                        <li>
                            <a href="https://templates.iqonic.design/streamit-dist/frontend/blog/blog-tag.html" class="position-relative">Action</a>
                        </li>
                        <li>
                            <a href="https://templates.iqonic.design/streamit-dist/frontend/blog/blog-tag.html" class="position-relative">Adventure</a>
                        </li>
                        <li>
                            <a href="https://templates.iqonic.design/streamit-dist/frontend/blog/blog-tag.html" class="position-relative">Astronomy</a>
                        </li>
                        <li>
                            <a href="https://templates.iqonic.design/streamit-dist/frontend/blog/blog-tag.html" class="position-relative">circus</a>
                        </li>
                        <li>
                            <a href="https://templates.iqonic.design/streamit-dist/frontend/blog/blog-tag.html" class="position-relative">Crime</a>
                        </li>
                    </ul>
                </div> -->
                <!-- <div class="mt-4">
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <ul class="list-inline m-0 d-inline-flex align-items-center gap-2">
                            <li><small>English (New Zealand)</small></li>
                        </ul>
                    </div>
                </div> -->
...
<!-- <div class="streamit-mobile-footer-menu" aria-label="Mobile Footer Navigation">
    <ul class="footer-menu list-inline d-flex align-items-center justify-content-between m-0">
        <li class="footer-menu-item">
            <a href="video-player" class="menu-link font-size-12">
        ...
        <li class="footer-menu-item">
            <a href="video-player" class="menu- font-size-12">
        ...
        <div class="row gy-4">
          <div class="col-lg-3 col-sm-6">
            <div class="footer-logo"> -->
              ...
              <!-- <div class="logo-default">
                  <a class="navbar-brand text-info me-0" href="index.html"> -->
                      <!-- <img class="img-fluid logo" src="assets/images/logo.png" loading="lazy" alt="streamit" /> -->
                      <!-- <img class="img-fluid logo" src="logo.svg" loading="lazy" alt="Bunma" />
                  </a>
              </div> -->
              <!-- <div class="logo-hotstar">
                  <a class="navbar-brand text-info me-0" href="index.html">
            ...
            <!-- </div>
            <div>Email us: <span class="text-white">customer@streamit.com</span>
            </div>
          ...
          <div class="col-lg-2 col-sm-6">
            ...
            <ul class="list-unstyled footer-menu mb-0">
              <li>
                <a class="text-capitalize" href="video-player"><span>Top trending</span></a>
              </li>
              <li>
                <a class="text-capitalize" href="video-player"><span>Recommended</span></a>
              </li>
              <li>
                <a class="text-capitalize" href="video-player"><span>Popular</span></a>
              </li>
            </ul>
          </div>
          <div class="col-lg-2 col-sm-6">
            ...
            <ul class="list-unstyled footer-menu mb-0">
              <li>
                <a class="text-capitalize" href="contact-us.html"><span>contact us</span></a>
              </li>
              <li>
                <a class="text-capitalize" href="pricing-plan.html"><span>Pricing Plan</span></a>
              </li>
              <li>
                <a class="text-capitalize" href="blog/blog-listing.html"><span>Blog</span></a>
              </li>
              <li>
                <a class="text-capitalize" href="faq.html"><span>FAQ</span></a>
              </li>
            </ul>
          </div>
          <div class="col-lg-2 col-sm-6">
            ...
            <ul class="list-unstyled footer-menu mb-0">
              <li>
                <a class="text-capitalize" href="about-us.html"><span>about us</span></a>
              </li>
              <li>
                <a class="text-capitalize" href="shop/shop.html"><span>shop</span></a>
              </li>
              <li>
                <a class="" href="terms-of-use.html"><span>Terms and Use</span></a>
              </li>
              <li>
                <a class="text-capitalize" href="privacy-policy.html"><span>privacy policy</span></a>
              </li>
            </ul>
          </div>
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="mailchimp mailchimp-dark">
              <div class="input-group">
                <input type="text" class="form-control mb-0" placeholder="Email" aria-describedby="button-addon2">
                <div class="iq-button">
                  <button type="submit" class="btn btn-info st-subscribe-btn" id="button-addon2">Subscribe</button>
                </div>
              </div>
            </div>
            <div class="d-flex align-items-center gap-3 widget-streamit-social-media mt-4">
              <h3 class="font-size-14 widget-streamit-social-media-title">Follow Us:</h3>
    ...
    <div class="footer-bottom">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-md-6">
            <p class="font-size-14 mb-0">© <span class="currentYear"></span> <span class="text-info">STREAMIT.</span>
              All
              Rights Reserved. All videos and shows on this platform are trademarks of, and all related images and
              content
              are the property of, Streamit Inc. Duplication and copy of this is strictly prohibited.</p>
          </div>
            ...
            <div class="d-flex flex-column align-items-start align-items-md-end widget-iq-download-app">
              ...
              <div>
                <ul class="d-inline-flex flex-wrap align-items-center list-inline m-0 p-0 gap-3">
                  <li class="m-0 p-0">
                    <a class="app-image" href="video-player">
                      <img src="assets/images/footer/play-store.webp" loading="lazy" alt="play-store" />
                    </a>
                  </li>
                  <li class="m-0 p-0">
                    <a class="app-image" href="video-player">
                      <img src="assets/images/footer/app-store.webp" loading="lazy" alt="app-store" />
                    </a>
                  </li>
                </ul>
              </div>
  ...
  <!-- <div class="rtl-box">
      ...
      <div class="offcanvas offcanvas-end live-customizer on-rtl end" tabindex="-1" id="live-customizer"
          ...
          <div class="offcanvas-header gap-3 justify-content-between">
              ...
              <div class="d-flex gap-1 align-items-center">
                  <button class="btn btn-icon text-info" data-reset="settings" data-bs-toggle="tooltip"
    ...
    </div>  <div id="back-to-top" class="back-to-top" style="display: none;">
     <a class="p-0 btn bg-info btn-sm position-fixed top border-0 rounded-circle text-white" id="top" href="video-detail.html#top">
