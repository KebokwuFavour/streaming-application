...
// // Re-initialize Bootstrap collapse elements on mount
// onMounted(() => {
//   //   // Force Bootstrap collapse re-init
...
//     // Ensure Bootstrap collapse is bound to each
...
onMounted(() => {
  if (collapse.value) {
    // ✅ Initialize Bootstrap collapse only once
    bsCollapse = new window.bootstrap.Collapse(collapse.value, {
      toggle: false,
    });
  }
});
  ...
  <div>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto align-items-start">
            ...
            <li class="nav-item" v-if="$page.props.auth.user || !$page.props.auth.user">
              <a class="nav-link" :class="{ active: $page.url === '/' }" href="/">Home</a>
            </li>

            <li class="nav-item" v-if="$page.props.auth.user || !$page.props.auth.user">
              <a
                class="nav-link"
                :class="{ active: $page.url.startsWith('/features') }"
                href="#"
                >Features</a
              >
            </li>
            ...
            <li class="nav-item" v-if="$page.props.auth.user || !$page.props.auth.user">
              <a
                class="nav-link"
                :class="{ active: $page.url.startsWith('/pricing') }"
                href="#"
                >Pricing</a
              >
            </li>
            ...
            <li class="nav-item" v-if="!$page.props.auth.user">
              <Link
                :href="route('login')"
                class="btn btn-outline-light ms-2 me-2 mb-3 mb-md-0"
              >
                Log in
              </Link>
            </li>

            <li class="nav-item" v-if="!$page.props.auth.user && canRegister">
              <Link
                :href="route('register')"
    ...
    <section class="bg-dark text-white text-center py-5">
      <div class="container">
        ...
        <p class="lead mb-4">
          Your all-in-one live streaming platform built for speed, clarity, and
          experience.
        </p>
        <a href="#" class="btn btn-lg btn-primary me-2">
    ...
    <section class="py-5">
      <div class="container">
        <div class="row text-center mb-4">
          <h2 class="fw-bold">Why Choose StreamX?</h2>
          <p class="text-muted">Built with reliability, speed, and quality at its core</p>
        </div>
        <div class="row g-4">
          <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body text-center">
                ...
                <h5 class="fw-bold">Seamless Streaming</h5>
                <p class="text-muted">
                  Enjoy high-quality live streaming without interruptions.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body text-center">
                ...
                <p class="text-muted">
                  Your data and streams are protected with top-notch security.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body text-center">
                ...
                <p class="text-muted">Experience lightning-fast performance at scale.</p>
              </div>
            </div>
          </div>
        </div>
